...
import org.phpaspect.weaver.java_cup.runtime.SymbolFactory;
import org.phpaspect.weaver.java_cup.runtime.lr_parser;
...
abstract public class PHPAspectAbstractParser extends lr_parser {
	...
	public PHPAspectAbstractParser() {
		super();
	}

	public PHPAspectAbstractParser(Scanner s) {
		super(s);
	}

	public PHPAspectAbstractParser(Scanner s, SymbolFactory sf) {
		super(s, sf);
	}
