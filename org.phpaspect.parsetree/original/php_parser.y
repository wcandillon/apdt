...
top_statement:
    ...
    /* added by William Candillon <wcandillon@php.net> */
    |       T_ASPECT T_STRING '{' aspect_statement_list '}'
    /* added by William Candillon <wcandillon@php.net> */
    |       T_DOC_COMMENT
;
...
aspect_statement_list:
		aspect_statement_list aspect_statement
        |       /* empty */
;
...
aspect_statement:
                class_statement
        |       variable_modifiers aspect_variable_introduction ';'
        |       aspect_constant_introduction ';'
	|	method_modifiers T_FUNCTION is_reference aspect_class_signature T_PAAMAYIM_NEKUDOTAYIM T_STRING '(' parameter_list ')' method_body
	|	T_POINTCUT T_STRING ':' aspect_pointcut ';'
	|	T_BEFORE '(' aspect_advices_variables ')' ':' aspect_pointcut '{' inner_statement_list '}'
	|	T_AROUND '(' ')' ':' aspect_pointcut '{' inner_statement_list '}'
	|	T_AFTER  '(' aspect_advices_variables ')' ':' aspect_pointcut '{' inner_statement_list '}'
        T_DOC_COMMENT
	/*|       method_modifiers T_FUNCTION is_reference aspect_class_signature aspect_subtype_or_not T_PAAMAYIM_NEKUDOTAYIM T_STRING '(' parameter_list ')' method_body*/
;
...
/* added by William Candillon <wcandillon@php.net> */
aspect_pointcut:
		aspect_pointcut T_BOOLEAN_OR aspect_pointcut
	|	aspect_pointcut T_BOOLEAN_AND aspect_pointcut
	|	'(' aspect_pointcut ')'
	|	'!' aspect_pointcut
	|	aspect_joinpoint
;
...
aspect_joinpoint:
		T_STRING
	|	T_CALL  '(' aspect_signature_r aspect_call aspect_signature '(' aspect_parameters ')' ')'
	|	T_EXEC  '(' method_modifiers is_reference aspect_signature T_PAAMAYIM_NEKUDOTAYIM
                aspect_signature aspect_subtype_or_not '(' aspect_parameters ')' ')'
	|	T_NEW   '('aspect_signature_r '(' aspect_parameters ')' ')'
	|	T_CATCH '(' aspect_class_signature ')'
	|	T_UNSET	'(' aspect_class_signature ')'
        |       T_SET   '(' aspect_signature aspect_call aspect_signature ')'
        |       T_GET   '(' aspect_signature aspect_call aspect_signature ')'
        |       T_THIS  '(' aspect_signature_r ')'
        |       T_WITHIN '(' aspect_signature_r ')'
        |       T_FILE   '(' T_CONSTANT_ENCAPSED_STRING ')'
        |       '@' aspect_signature_r
;
...
aspect_variable_introduction:
	...
	|	aspect_class_signature T_PAAMAYIM_NEKUDOTAYIM T_VARIABLE
	|	aspect_class_signature T_PAAMAYIM_NEKUDOTAYIM T_VARIABLE '=' static_scalar
;

/* added by William Candillon <wcandillon@php.net> */
aspect_constant_introduction:
		aspect_constant_introduction ',' aspect_class_signature T_PAAMAYIM_NEKUDOTAYIM T_STRING '=' static_scalar
	|	T_CONST aspect_class_signature T_PAAMAYIM_NEKUDOTAYIM T_STRING '=' static_scalar
;


/* added by William Candillon <wcandillon@php.net> */
aspect_class_signature:
...
/* added by William Candillon <wcandillon@php.net> */
aspect_signature_r:
    aspect_signature aspect_subtype_or_not
;
aspect_signature:
                aspect_signature '*'
